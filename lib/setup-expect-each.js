...
/**
 * Setup expect.each() of Jest.
 *
 * @returns {void} - No return value.
 */
export function setupExpectEach () {
  /**
    ...
    get: (_, matcherName) => {
      if (matcherName === 'not') {
        return new Proxy(expect, {
           ...
           * get() for Proxy sink.
           *
           * @param {typeof expect} __
           * @param {string} notMatcherName
           * @returns {Function} - Matcher handler.
           */
          get: (__, notMatcherName) =>
